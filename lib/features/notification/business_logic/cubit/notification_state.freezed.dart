...
mixin _$NotificationState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<NotifiticationModel> data) success,
    required TResult Function(DioExceptionType networkExceptions) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<NotifiticationModel> data)? success,
    TResult? Function(DioExceptionType networkExceptions)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class __$$IdleCopyWithImpl<T, $Res>
    extends _$NotificationStateCopyWithImpl<T, $Res, _$Idle<T>>
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$NotificationStateCopyWithImpl<T, $Res, _$Loading<T>>
...
abstract class _$$SuccessCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<NotifiticationModel> data});
}

/// @nodoc
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$NotificationStateCopyWithImpl<T, $Res, _$Success<T>>
...
class _$Success<T> implements Success<T> {
  const _$Success(final List<NotifiticationModel> data) : _data = data;

  final List<NotifiticationModel> _data;
  @override
  List<NotifiticationModel> get data {
...
abstract class Success<T> implements NotificationState<T> {
  const factory Success(final List<NotifiticationModel> data) = _$Success<T>;
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$NotificationStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'NotificationState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements NotificationState<T> {
  const factory Error(final DioExceptionType networkExceptions) = _$Error<T>;
