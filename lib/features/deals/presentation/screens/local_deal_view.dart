...
class LocalDealsView extends StatefulWidget {
  const LocalDealsView({super.key});

  @override
  State<LocalDealsView> createState() => _LocalDealsViewState();
}

class _LocalDealsViewState extends State<LocalDealsView> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<DealsCubit>(context).getAllCategories(type: 'local');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(AppStrings.local),
      ),
