...
import 'package:merchant_extras/features/auth/presentation/widgets/custom_country_code/custom_country_code.dart';
import 'package:merchant_extras/features/auth/presentation/widgets/custom_country_code/custom_selection_dialog.dart';

class CustomCountryPicker extends StatefulWidget {
  final ValueChanged<CustomCountryCode>? onChanged;
  final ValueChanged<CustomCountryCode?>? onInit;
  ...
  final Function(CustomCountryCode?)? builder;
  final bool enabled;
  ...
  final Comparator<CustomCountryCode>? comparator;
  ...
  State<StatefulWidget> createState() {
    ...
    List<CustomCountryCode> elements =
        jsonList.map((json) => CustomCountryCode.fromJson(json)).toList();
...
class CountryCodePickerState extends State<CustomCountryPicker> {
  CustomCountryCode? selectedItem;
  List<CustomCountryCode> elements = [];
  List<CustomCountryCode> favoriteElements = [];
  ...
  void _publishSelection(CustomCountryCode countryCode) {
    if (widget.onChanged != null) {
      widget.onChanged!(countryCode);
    }
  }

  void _onInit(CustomCountryCode? countryCode) {
